...
namespace WebDoctors.Data.Migrations
{
    ...
    [Migration("20210802190700_AddAppoinmentsAndConsuldationTypes")]
    partial class AddAppoinmentsAndConsuldationTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDoctors.Data.ConsultationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebDoctors.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("WebDoctors.Data.Appointment", b =>
                {
                    b.HasOne("WebDoctors.Data.ConsultationType", "ConsultationType")
                        .WithMany()
                        .HasForeignKey("ConsultationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebDoctors.Data.Customer", "Customer")
                        .WithMany()
